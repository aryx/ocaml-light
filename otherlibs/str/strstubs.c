...
value re_string_match(value re, value str, value pos)  /* ML */
{
...
value re_partial_match(value re, value str, value pos)  /* ML */
{
  unsigned char * starttxt = &Byte_u(str, 0);
  unsigned char * txt = &Byte_u(str, Long_val(pos));
  unsigned char * endtxt = &Byte_u(str, string_length(str));
...
value re_search_forward(value re, value str, value startpos)  /* ML */
{
  unsigned char * starttxt = &Byte_u(str, 0);
...
value re_search_backward(value re, value str, value startpos)  /* ML */
{
  unsigned char * starttxt = &Byte_u(str, 0);
  unsigned char * txt = &Byte_u(str, Long_val(startpos));
  unsigned char * endtxt = &Byte_u(str, string_length(str));
...
value re_replacement_text(value repl, value groups, value orig)  /* ML */
{
